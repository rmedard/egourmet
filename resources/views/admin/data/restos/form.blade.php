...
<div class="md-form">
    {{Form::text('name', isset($resto) ? $resto['name'] : null, ['class' => 'form-control validate', 'id' => 'resto-form-name'])}}
...
<div class="row">
    <div class="col-md-8">
        <div class="md-form">
            {{Form::text('tel', isset($resto) ? $resto['tel'] : null, ['class' => 'form-control validate', 'id' => 'resto-form-tel'])}}
            <label for="resto-form-tel" class="">{{trans('gui.tel')}}</label>
        </div>
        <div class="md-form">
            {{Form::text('website', isset($resto) ? $resto['website'] : null, ['class' => 'form-control validate', 'id' => 'resto-form-website'])}}
            <label for="resto-form-website" class="">{{trans('gui.website')}}</label>
        </div>
        <div class="md-form">
            {{Form::text('facebook', isset($resto) ? $resto['facebook'] : null, ['class' => 'form-control validate', 'id' => 'resto-form-facebook'])}}
    ...
    <div class="col-md-4" style="text-align: center;">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
                <?php $photo = isset($resto['mainphoto']) ? $resto['mainphoto'] : config('constants.noresto') ?>
                {!! Html::image($photo, 'Choose photo', ['width' => 150, 'height' => 150]) !!}
            </div>
